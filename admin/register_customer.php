...
<head>
  ...
  <title>Customer Register - Maison Sakura</title>
...
<div class="container mt-5">
  ...
  <!-- Title -->
  <h3 class="m-0">Customer Registration</h3>
</div>
<!--link to another php files -->
...
<div class="form-check mb-3"> <!--terms and conditions--> <!--mantatory-->
  <input class="form-check-input" type="checkbox" required>
  <label class="form-check-label">I agree to the Terms & Conditions</label>
</div>
<div class="form-check mb-3"> <!--promotion and updates-->
  <input class="form-check-input" type="checkbox" name="newsletter">
  <label class="form-check-label">Subscribe to bakery promotions & updates</label>
</div>
            <!-- Hidden role for customer --> <!-- submit button and transfer info inside the database-->
            <input type="hidden" name="role" value="customer">
            <button type="submit" class="Register-Button">Register</button>
          </form>
<br/> <!--click to another php files (html) -->
   <div class="register-link">
   <p>Already have an account? <a href="login_customer.php">Login here</a></p>
   </div>
 <div class="register-link">
   <p><a href="customer_terms&conditions.php">Terms & Conditions</a></p>
   </div>
 <div class="register-link">
   <p><a href="customer_privacy_policy.php">Privacy Policy</a></p>
   </div>
        </div>
      </div>
    </div>
